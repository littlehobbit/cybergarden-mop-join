                ...
                .enqueue(new Callback<Void>() {
                    ...
                    public void onResponse(@NonNull Call<Void> call, @NonNull Response<Void> response) {
                        if (response.isSuccessful()) {
                            Toast.makeText(SignUpScreen.this, "basic registration is success", Toast.LENGTH_SHORT).show();
                ...
                .enqueue(new Callback<LoginResults>() {
                    ...
                    public void onResponse(@NonNull Call<LoginResults> call, @NonNull Response<LoginResults> response) {
                        if (response.isSuccessful()) {
                            ...
                            Toast.makeText(SignUpScreen.this, "login after registration is success", Toast.LENGTH_SHORT).show();
                    ...
                    public void onFailure(@NonNull Call<LoginResults> call, @NonNull Throwable t) {
                        ...
                        Toast.makeText(SignUpScreen.this, "Error while login after registration", Toast.LENGTH_SHORT).show();
                        t.printStackTrace();
                    }
                });
    }
    ...
    void registrationUserFullNameBirthday() {
        NetworkService.getInstance()
                ...
                .enqueue(new Callback<Void>() {
                    ...
                    public void onResponse(@NonNull Call<Void> call, @NonNull Response<Void> response) {
                        if (response.isSuccessful()) {
                            Toast.makeText(SignUpScreen.this, "you set full name and birthday is success", Toast.LENGTH_SHORT).show();
                    ...
                    public void onFailure(@NonNull Call<Void> call, @NonNull Throwable t) {
                        ...
                        Toast.makeText(SignUpScreen.this, "Error while set full name and birthday", Toast.LENGTH_SHORT).show();
                        t.printStackTrace();
                    }
                });
    }
    ...
    void setUserSettings() {
        NetworkService.getInstance()
                ...
                .enqueue(new Callback<Void>() {
                    ...
                    public void onResponse(@NonNull Call<Void> call, @NonNull Response<Void> response) {
                        if (response.isSuccessful()) {
                            Toast.makeText(SignUpScreen.this, "set user profile fields is success", Toast.LENGTH_SHORT).show();
                            Intent intent = new Intent(SignUpScreen.this, MainActivity.class);
                            startActivity(intent);
                        }
                    }
                    ...
                    public void onFailure(@NonNull Call<Void> call, @NonNull Throwable t) {
                        ...
                        Toast.makeText(SignUpScreen.this, "Error while set user profile fields", Toast.LENGTH_SHORT).show();
                        t.printStackTrace();
                    }
                });
    }
